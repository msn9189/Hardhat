...
var Api = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!ethers_1.utils.isAddress(opts.publicAddress)) {
                            Logger_1.log.throwMissingArgumentError(Logger_1.Logger.message.invalid_public_address, {
                                location: Logger_1.Logger.location.SDK_GETNFTS,
                            });
                            Logger_1.log.throwArgumentError(Logger_1.Logger.message.invalid_token_address, 'publicAddress', opts.publicAddress, {
                                location: Logger_1.Logger.location.SDK_GETNFTS,
                            });
                        }
                        if (opts.tokenAddresses) {
                            opts.tokenAddresses.forEach(function (item) {
                                if (!ethers_1.utils.isAddress(item)) {
                                    Logger_1.log.throwArgumentError(Logger_1.Logger.message.invalid_token_address, 'tokenAddresses', item, {
                                        location: Logger_1.Logger.location.SDK_GETNFTS,
                                    });
                                }
                            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (opts.fromBlock != null && !(0, utils_1.isValidPositiveNumber)(opts.fromBlock)) {
                            Logger_1.log.throwArgumentError(Logger_1.Logger.message.invalid_block_number, 'fromBlock', opts.fromBlock, {
                                location: Logger_1.Logger.location.SDK_GET_TRANSFERS_BY_WALLET,
                            });
                        }
                        if (opts.toBlock != null && !(0, utils_1.isValidPositiveNumber)(opts.toBlock)) {
                            Logger_1.log.throwArgumentError(Logger_1.Logger.message.invalid_block_number, 'toBlock', opts.toBlock, {
                                location: Logger_1.Logger.location.SDK_GET_TRANSFERS_BY_WALLET,
                            });
                        }
                        if (opts.fromBlock != null && opts.toBlock != null && opts.fromBlock > opts.toBlock) {
                            Logger_1.log.throwError(Logger_1.Logger.message.invalid_block_range, Logger_1.Logger.code.INVALID_ARGUMENT, {
                                location: Logger_1.Logger.location.SDK_GET_TRANSFERS_BY_WALLET,
    ...
    Api.prototype.getTransfersByContractAddress = function (opts) {
        return __awaiter(this, void 0, void 0, function () {
            var apiUrl, contractAddress, fromBlock, toBlock, cursor, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!opts.contractAddress || !ethers_1.utils.isAddress(opts.contractAddress)) {
                        ...
                        if (opts.fromBlock != null && opts.toBlock != null) {
                            ...
                            if (opts.toBlock - opts.fromBlock > 1000000) {
                                Logger_1.log.throwError(Logger_1.Logger.message.block_range_too_large, Logger_1.Logger.code.INVALID_ARGUMENT, {
                                    location: Logger_1.Logger.location.SDK_GET_TRANSFERS_BY_CONTRACT,
                                    fromBlock: opts.fromBlock,
                                    toBlock: opts.toBlock,
                                });
                        ...
                        contractAddress = opts.contractAddress, fromBlock = opts.fromBlock, toBlock = opts.toBlock, cursor = opts.cursor;
                        return [4 /*yield*/, this.httpClient.get(apiUrl, {
